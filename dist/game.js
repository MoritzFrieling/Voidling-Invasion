(() => {
  ...
  const TRANSLATIONS = {
    ...
    ko: {
      ...
      'menu.beginDefense': '방어 시작', 'menu.beginNewDefense': '새 방어 시작', 'menu.playCheckpointTop': '마지막', 'menu.playCheckpointBottom': '저장 지점부터 시작', 'menu.checkpointSector': '구역 {level}', 'menu.checkpointStage': '스테이지 {stage}', 'menu.trainingRun': '훈련 시작', 'menu.levelSelect': '구역 선택', 'menu.topPilots': '최고 조종사', 'menu.ranksShortcut': '순위',
