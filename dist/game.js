(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'menu.beginDefense': 'BEGIN DEFENSE', 'menu.playCheckpointTop': 'PLAY FROM', 'menu.playCheckpointBottom': 'LAST CHECK-POINT', 'menu.trainingRun': 'TRAINING RUN', 'menu.levelSelect': 'LEVEL SELECT', 'menu.topPilots': 'TOP PILOTS', 'menu.ranksShortcut': 'RANKS',
    ...
    ko: {
      ...
      'menu.beginDefense': '방어 시작', 'menu.playCheckpointTop': '마지막', 'menu.playCheckpointBottom': '저장 지점부터 시작', 'menu.trainingRun': '훈련 시작', 'menu.levelSelect': '구역 선택', 'menu.topPilots': '최고 조종사', 'menu.ranksShortcut': '순위',
